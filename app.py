from basedados import app, db, Produtos, Categorias, Subcategorias, Inventarios, Vendas, Carrinho, Produto_relacionado, Galeria_imagens, Utilizadores, Tipoutilizadores, Clientes,Conta_bancaria
